...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀:
// Inheritance: the nested or child function is inheriting from the outer or parent function.
...
function lowerCaseNames(data) {
  /*Your Code Here*/
  const lowerCaseNamesArray = data.map(function (item) {
...
function lowPopulationAnimals(data) {
  const lowPopulationArray = data.filter(function (item) {
